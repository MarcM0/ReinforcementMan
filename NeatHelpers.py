...
#         main.userReset(hard = True, newMap = False) #reset for next pac in generation
...
#     main.userReset(hard = True, newMap = ((main.current_generation % neatHyperparams["NumGenB4MapSwitch"]) == 0), coinFlip = True)
...
#         main.userReset(hard = True, newMap = True) #reset for next pac in generation    
